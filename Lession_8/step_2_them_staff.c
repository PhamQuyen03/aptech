 ...
 * GIAI DOAN 2 (STEP 2): STEP 1 + 1.3 Menu Thu thu (Staff)
 * Noi dung moi: them struct Sach, struct PhieuMuon, menu Thu thu
 * quan ly sach va nghiep vu muon/tra sach (lay nguyen code STEP 1 lam tiep)
 */
